...
public class AlbumAdapter extends SelectAdapter<Album, AlbumAdapter.Holder> implements FastScrollRecyclerView.SectionedAdapter {
    public AlbumAdapter(Context context, List<Album> dataList, int itemType, boolean usePalette) {
    ...
    public String getSectionName(int position) {
        return MusicUtil.getSectionName(mDataList.get(position).getTitle());
    }
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void onBind(Album album) {
            itemView.setActivated(album.isSelected());
