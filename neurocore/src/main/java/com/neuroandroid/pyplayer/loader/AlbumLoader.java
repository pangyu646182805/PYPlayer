...
public class AlbumLoader {
    public static String getSongLoaderSortOrder(Context context) {
        return SPUtils.getString(context, Constant.ALBUM_SORT_ORDER, SortOrder.AlbumSortOrder.ALBUM_A_Z) +
                ", " + SPUtils.getString(context, Constant.ALBUM_SONG_SORT_ORDER, SortOrder.AlbumSongSortOrder.SONG_TRACK_LIST);
